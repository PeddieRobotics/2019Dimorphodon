...
public class ElectricalLayout {
  ...
  //solenoids
  public static final int SOLENOID_FLOOR_PIVOT = 0;
  public static final int SOLENOID_FLOOR_CLAMP = 1;
  public static final int SOLENOID_HATCH_PIVOT = 2;
  public static final int SOLENOID_HATCH_GRABBER = 3;
  public static final int SOLENOID_HATCH_DEPLOY = 4;
